...
// TODO(lnp): Adapt changes below unit test
...
// 	chain, receipts, _ := evmcore.GenerateChain(params.TestChainConfig, genesis, ethash.NewFaker(), backend.db, 100010, func(i int, gen *core.BlockGen) {
// 		switch i {
// 		case 2403:
...
// 	chain, receipts, _ := evmcore.GenerateChain(params.TestChainConfig, genesis, ethash.NewFaker(), backend.db, 1000, func(i int, gen *core.BlockGen) {
// 		switch i {
// 		case 1:
// 			receipt := types.NewReceipt(nil, false, 0)
// 			receipt.Logs = []*types.Log{
