...
admin.sleep(1);
var tx = ftm.sendTransaction({ from: ftm.accounts[0], to: a1, value: "10000000000000000000" });
admin.sleep(1);
...
var simpleContract = ftm.contract(abi);
var address = "";
var simple = simpleContract.new(42, { from: a1, data: bytecode, gas: 0x47b760 }, function (e, contract) { if (!e) { if (contract.address) console.log(contract.address); } });
admin.sleep(1);
