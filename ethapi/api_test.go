...
func newTestBackend(t *testing.T, n int, gspec *core.Genesis, generator func(i int, b *evmcore.BlockGen)) *ethapi.Backend {
	return nil
}

func setupReceiptBackend(t *testing.T, genBlocks int) (*ethapi.Backend, []common.Hash) {
...
func TestRPCGetTransactionReceipt(t *testing.T) {
	...
	var (
		...
		api               = ethapi.NewPublicTransactionPoolAPI(*backend, new(ethapi.AddrLocker))
	)
