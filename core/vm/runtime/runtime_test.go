...
import (
	...
	"github.com/unicornultrafoundation/go-u2u/consensus"
	"github.com/unicornultrafoundation/go-u2u/core/asm"
...
func fakeHeader(n uint64, parentHash common.Hash) *evmcore.EvmHeader {
...
func (d *dummyChain) GetHeader(h common.Hash, n uint64) *evmcore.EvmHeader {
	d.counter++
...
func TestBlockhash(t *testing.T) {
	...
	*/
	...
	ret, _, err := Execute(data, input, &Config{
		GetHashFn:   evmcore.GetHashFn(header, chain),
...
// correctly
// see: https://github.com/unicornultrafoundation/go-u2u/libs/issues/22649
