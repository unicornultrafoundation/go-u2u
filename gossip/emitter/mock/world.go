...
// Source: github.com/unicornultrafoundation/go-u2u/gossip/emitter (interfaces: External,TxPool,TxSigner,Signer)
...
import (
	...
	hash "github.com/unicornultrafoundation/go-u2u/consensus/hash"
	idx "github.com/unicornultrafoundation/go-u2u/consensus/native/idx"
	pos "github.com/unicornultrafoundation/go-u2u/consensus/native/pos"
...
func (m *MockExternal) GetRules() u2u.Rules {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRules")
	ret0, _ := ret[0].(u2u.Rules)
	return ret0
}
