...
func handleGetEpochReceivedStake(stateDB vm.StateDB, args []interface{}) ([]byte, uint64, error) {
...
func handleGetEpochAccumulatedRewardPerToken(stateDB vm.StateDB, args []interface{}) ([]byte, uint64, error) {
...
func handleGetEpochAccumulatedUptime(stateDB vm.StateDB, args []interface{}) ([]byte, uint64, error) {
...
func handleGetEpochAccumulatedOriginatedTxsFee(stateDB vm.StateDB, args []interface{}) ([]byte, uint64, error) {
...
func handleGetEpochOfflineTime(stateDB vm.StateDB, args []interface{}) ([]byte, uint64, error) {
