...
func TestHeliosClassicRoots(t *testing.T) {
...
func TestHeliosRandomRoots(t *testing.T) {
	// generated by codegen4HeliosRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01    
 ║         ║        
 ╠════════ B1.01    
...
/*
// codegen4HeliosRandomRoot is for test data generation.
func codegen4HeliosRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakeHelios(nodes)
	// process events
	config := inter.Events{}
